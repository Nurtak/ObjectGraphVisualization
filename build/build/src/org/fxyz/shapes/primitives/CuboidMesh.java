...
public class CuboidMesh extends TexturedMesh {
    ...
    private boolean drawTopFace = true;
    
    public boolean isDrawTopFace() {
		return drawTopFace;
	}
    ...
    public List<Integer> getBaseFaces() {
    	if(drawTopFace) {
    ...
    private TriangleMesh createCube(float width, float height, float depth, 
        ...
        if(level==0){
            ...
            final List<Integer> baseFaces = getBaseFaces();
