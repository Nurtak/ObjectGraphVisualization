...
public class UserPreferences {
    ...
    /**
     * Returns the ogv file preference, i.e. the file that was last opened. The preference is read from the OS specific
     * registry. If no such preference can be found, null is returned.
     *
    ...
    /**
     * Returns the xmi file preference, i.e. the file that was last opened. The preference is read from the OS specific
     * registry. If no such preference can be found, null is returned.
     *
     * @return the last used file or null.
     */
